...
import RetailTools from './components/RetailTools'
import AgricultureTools from './components/AgricultureTools'
import TransportationTools from './components/TransportationTools'
    ...
    <>
      <div className="app-container">
        ...
        <div className="main-content">
          ...
          {activeTab === 'construction' && ['pro', 'enterprise'].includes(user?.plan) && (
            <ConstructionTools 
              serverInfo={serverInfo}
              user={user}
              authToken={authToken}
          ...
          {activeTab === 'construction' && ['free', 'standard'].includes(user?.plan) && (
            <div className="upgrade-required">
              <h2>🔒 Premium Feature</h2>
              <p>Construction and engineering tools require a Pro or Enterprise subscription</p>
              <button onClick={() => setShowSubscriptionModal(true)}>
                Upgrade Now
              </button>
            </div>
          ...
          {activeTab === 'retail' && ['standard', 'pro', 'enterprise'].includes(user?.plan) && (
            <RetailTools 
              serverInfo={serverInfo}
              user={user}
              authToken={authToken}
          ...
          {activeTab === 'retail' && user?.plan === 'free' && (
            <div className="upgrade-required">
              <h2>🔒 Premium Feature</h2>
              <p>Retail and e-commerce optimization tools require a Standard, Pro, or Enterprise subscription</p>
              <button onClick={() => setShowSubscriptionModal(true)}>
                Upgrade Now
              </button>
            </div>
          ...
          {activeTab === 'agriculture' && ['standard', 'pro', 'enterprise'].includes(user?.plan) && (
            <AgricultureTools 
              serverInfo={serverInfo}
              user={user}
              authToken={authToken}
          ...
          {activeTab === 'agriculture' && user?.plan === 'free' && (
            <div className="upgrade-required">
              <h2>🔒 Premium Feature</h2>
              <p>Agriculture and farming tools require a Standard, Pro, or Enterprise subscription</p>
              <button onClick={() => setShowSubscriptionModal(true)}>
                Upgrade Now
              </button>
            </div>
          ...
          {activeTab === 'transportation' && ['standard', 'pro', 'enterprise'].includes(user?.plan) && (
            <TransportationTools 
              serverInfo={serverInfo}
              user={user}
              authToken={authToken}
          ...
          {activeTab === 'transportation' && user?.plan === 'free' && (
            <div className="upgrade-required">
              <h2>🔒 Premium Feature</h2>
              <p>Transportation and logistics tools require a Standard, Pro, or Enterprise subscription</p>
              <button onClick={() => setShowSubscriptionModal(true)}>
                Upgrade Now
              </button>
            </div>
          ...
          {activeTab === 'entertainment' && ['standard', 'pro', 'enterprise'].includes(user?.plan) && (
            <EntertainmentTools 
              serverInfo={serverInfo}
              user={user}
              authToken={authToken}
          ...
          {activeTab === 'entertainment' && user?.plan === 'free' && (
            <div className="upgrade-required">
              <h2>🔒 Premium Feature</h2>
              <p>Entertainment and media production tools require a Standard, Pro, or Enterprise subscription</p>
              <button onClick={() => setShowSubscriptionModal(true)}>
                Upgrade Now
              </button>
            </div>
